...
////////////////// arrow function///////////////////
let sum1 = (a,b,c,d) => `${a} + ${b} + ${c} + ${d} = ${a + b + c + d} `;

console.log('arrow function for sum ' , sum1(1, 2, 3, 4));
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
console.log('arrow function ' , objectLit1());
...
let sumAndProduct1 = (a,b) => {
  let sum = a + b;
  let product = a * b;
  return [sum, product];
}

console.log('arrow function' , sumAndProduct1(3, 9));
...
let message1 = name => `Hello, ${name}!`;
console.log('arrow function ' , message('Allie'));
...
// 1. What is "this" when joe.scope() is invoked? constractor object (joe)
//
// 2. What is "this" when joe.scopeArrow() is invoked?  window object
//
// 3. Explain why "this" is different when an arrow function is used. there is no scope for this inside arrow function thats why show window 
//
